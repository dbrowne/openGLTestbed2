...
LIBS=-framework GLUT -framework OpenGL -L/usr/local/lib/ -lglwf3
#  Linux/Unix/Solaris
else
CFLG=-O3 -Wall
LIBS=-lglut -lGLU -lGL -lm -lglwf3
endif
...
# Dependencies
main.o: main.cpp extra_funcs.h Camera.h Cylinder.h ellipse.h Parallelogram.h LightCube.h Camera.h
...
#  Create archive
CSCIx229.a:Color.o Cylinder.o ellipse.o extra_funcs.o glad.o LightCube.o Parallelogram.o primatives.o
	ar -rcs $@ $^
